    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <div style="margin-left:200px" class="row">
                <div class="col-md-4">
                    <div style="border-radius: 2em;" class="card card-body">
                        <div class="text-center ">
                            <img src="@if(Auth::user()->profileImage){{ asset('images')}}/{{Auth::user()->profileImage }}@else{{asset('images/avatar3.png')}}@endif" width="45%" class="rounded-circle" alt="">
                        </div>
                    ...
                    <div class="card card-body" style="border-radius: 2em;">                        
                        <form class="form-layout form-layout-1" action="{{route('change.password')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-layout-footer text-right mt-4">
                                <button type="submit" class="btn btn-primary tx-20" style="border-radius: 2em;"><i class="fa fa-floppy-o mr-2"></i> Submit</button>
                            </div>
                        </form>
                    </div>
                </div>
